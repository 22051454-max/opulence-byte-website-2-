...
export default function TeamSection() {
  ...
  const teamMembers = [
    {
      ...
      description: "Visionary leader with 5+ years in technology innovation and digital transformation.",
      social: {
        linkedin: "https://www.linkedin.com/in/avinash-singh-munda-4a71a0211/",
        twitter: "https://x.com/avimunda11",
        facebook: "https://www.facebook.com/profile.php?id=61556124270499",
        instagram: "https://www.instagram.com/avimunda11/",
      },
    },
    {
      name: "Avinash Singh Munda",
      ...
      image: "/images/founder.jpeg",
      description: "Technical architect specializing in cloud infrastructure and scalable system design.",
      social: {
        linkedin: "https://www.linkedin.com/in/avinash-singh-munda-4a71a0211/",
        twitter: "https://x.com/avimunda11",
        facebook: "https://www.facebook.com/profile.php?id=61556124270499",
  ...
  return (
    <section id="team" ref={ref} className="py-20 md:py-32 bg-[#020924] relative">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            Meet Our{" "}
            <span className="bg-gradient-to-r from-[#d4af37] to-[#f5d76e] bg-clip-text text-transparent">Team</span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-[#d4af37] to-[#f5d76e] mx-auto mb-6"></div>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">
            The visionary minds behind Opulence Byte, driving innovation and excellence in every project.
          </p>
        </motion.div>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="relative">
                ...
                <div className="relative glass bg-[#0f0f0f]/80 backdrop-blur-sm p-8 rounded-lg border border-[#d4af37]/20 h-full">
                  <div className="flex flex-col items-center text-center">
                    <motion.div className="relative mb-6" whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
                      ...
                      <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-[#d4af37]/50 shadow-2xl">
                        <Image
