        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-3 bg-gradient-to-r from-[#1B4965] to-[#00D0FF] text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-[#00D0FF]/50 transition-all duration-300 flex items-center justify-center gap-2 tech-cursor">
                Get Started
                <ArrowRight className="w-4 h-4" />
              </button>
              <button className="px-8 py-3 border border-border rounded-lg font-semibold hover:bg-muted transition-colors tech-cursor">
                Learn More
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 mt-12">
              <div>
                <div className="text-3xl font-bold titanium-glow">100%</div>
                <p className="text-sm text-muted-foreground">Client Satisfaction</p>
              </div>
              <div>
                <div className="text-3xl font-bold titanium-glow">24/7</div>
                <p className="text-sm text-muted-foreground">Support Available</p>
              </div>
              <div>
                <div className="text-3xl font-bold titanium-glow">6+</div>
          ...
          <div className="relative animate-slide-in-left">
            ...
            <div className="relative bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-2xl p-8 border border-[#2D3748]">
